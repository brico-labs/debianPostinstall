...
\subsection{Terminator}\label{terminator}

Terminator es un emulador de terminal muy completo. Los instalamos desde
\emph{aptitude}
...
\subsection{Keepass2}\label{keepass2}
...
\subsection{gksu}\label{gksu}

\begin{verbatim}
sudo aptitude install gksu
\end{verbatim}

\subsection{Diskmanager}\label{diskmanager}
...
\subsection{\texorpdfstring{Herramientas
...
\subsection{Menulibre}\label{menulibre}
...
directorio \emph{\textasciitilde{}/Pinguino/v11}, parece que hay algún
problema con el programa y no lo crea automáticamente.

El programa queda correctamente instalado en \emph{/opt}
